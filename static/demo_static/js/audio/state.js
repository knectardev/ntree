...
(function() {
    ...
    const ui = {
        ...
        hihatOn: document.getElementById('audioHihatOn'),
        tomOn: document.getElementById('audioTomOn'),
        congaOn: document.getElementById('audioCongaOn'),
        cymbalOn: document.getElementById('audioCymbalOn'),
        claveOn: document.getElementById('audioClaveOn'),
        ...
        hihatLevel: document.getElementById('audioHihatLevel'),
        hihatLevelLabel: document.getElementById('audioHihatLevelLabel'),
        tomLevel: document.getElementById('audioTomLevel'),
        tomLevelLabel: document.getElementById('audioTomLevelLabel'),
        congaLevel: document.getElementById('audioCongaLevel'),
        congaLevelLabel: document.getElementById('audioCongaLevelLabel'),
        cymbalLevel: document.getElementById('audioCymbalLevel'),
        cymbalLevelLabel: document.getElementById('audioCymbalLevelLabel'),
        claveLevel: document.getElementById('audioClaveLevel'),
        claveLevelLabel: document.getElementById('audioClaveLevelLabel'),
        ...
        hihatDecay: document.getElementById('audioHihatDecay'),
        hihatDecayLabel: document.getElementById('audioHihatDecayLabel'),
        tomDecay: document.getElementById('audioTomDecay'),
        tomDecayLabel: document.getElementById('audioTomDecayLabel'),
        congaDecay: document.getElementById('audioCongaDecay'),
        congaDecayLabel: document.getElementById('audioCongaDecayLabel'),
        cymbalDecay: document.getElementById('audioCymbalDecay'),
        cymbalDecayLabel: document.getElementById('audioCymbalDecayLabel'),
        claveDecay: document.getElementById('audioClaveDecay'),
        claveDecayLabel: document.getElementById('audioClaveDecayLabel'),
